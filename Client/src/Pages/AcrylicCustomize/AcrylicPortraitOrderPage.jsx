      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
        ...
        <div className="space-y-6">
          <label className="block text-2xl font-semibold text-center mb-3">
            <p>Preview Your Acrylic Portrait</p>
            <p>With Custom Zoom and Position</p>
          </label>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg space-y-8 border border-gray-200">
          ...
          <div className="text-center text-sm text-gray-800 space-y-4">
            ...
            >
              <FaPhoneAlt size={18} /> Call & Book Bulk Orders
            </button>
            <button
              onClick={() =>
            ...
            >
              <FaPhoneAlt size={18} /> Chat on WhatsApp for Bulk Orders
            </button>
          </div>
        </div>
      </div>
...
export default AcrylicPortraitOrderpage;
