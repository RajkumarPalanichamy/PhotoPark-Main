...
import contact from "../assets/frontend_assets/BestSellers/Frame1.jpeg";
import {
  FaSquareEnvelope,
  FaSquarePhone,
  FaSquareInstagram,
    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-gray-50 p-4 md:p-16 rounded-2xl shadow-lg max-w-6xl mx-auto mt-16">
        ...
        <div className="space-y-8 text-gray-800 mt-5">
          ...
          <div>
            ...
            <p className="text-sm md:text-base text-gray-600 max-w-sm">
              Tiruppur - Perumanallur Rd, Ram Nagar, Tiruppur, Tamil Nadu 641602
            </p>
          </div>
          <hr className="border-t border-gray-300" />
        </div>
        ...
        <div className="flex items-center justify-center">
          <form className="w-full max-w-md bg-white p-6 md:p-8 rounded-xl shadow-xl space-y-6">
