      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg space-y-8 border border-gray-200">
          ...
          <div className="text-center text-sm text-gray-800 space-y-4">
            ...
            <p className="text-gray-600">Perfect for Gifts and Return Gifts.</p>
          ...
          <div className="bg-gray-100 border border-gray-300 p-4 rounded-lg mt-6">
            ...
            <div className="flex">
              ...
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-r-md font-semibold transition duration-200"
              >
                Check
              </button>
            </div>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400 mb-3 text-sm"
            />
            <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md w-full flex items-center justify-center gap-2 font-semibold transition duration-200 shadow">
              <FaEnvelope size={16} />
              Submit Enquiry
            </button>
          </div>
