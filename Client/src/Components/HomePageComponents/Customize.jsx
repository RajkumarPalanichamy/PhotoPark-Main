  ...
  return (
    <div className="mt-20 flex flex-col items-center justify-center p-4 mx-[7vw] sm:mx-[7vw]">
      ...
      <p className="text-base sm:text-lg text-gray-600 mb-12 text-center max-w-2xl font-[poppins]">
        Choose your favorite frame style and preview it in real-time. Make you  r
          ...
          >
            {frameImages.map((frame, index) => {
              ...
              return (
                ...
                >
                  <div className="relative z-10 bg-white/80 p-4 rounded-xl shadow-lg text-center max-w-[80%]">
