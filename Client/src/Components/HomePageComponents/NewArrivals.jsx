    ...
    <div className="mt-20 text-center font-[poppins]">
      ...
      >
        ...
        <div className="absolute z-10 top-1/2 -translate-y-1/2 left-4">
          <button className="swiper-button-prev bg-white p-3 rounded-full shadow hover:bg-orange-200 transition border-1">
            ◀
          </button>
        </div>
        <div className="absolute z-10 top-1/2 -translate-y-1/2 right-4">
          <button className="swiper-button-next bg-white p-3 rounded-full shadow hover:bg-orange-200 transition border-1">
            ▶
          </button>
        </div>
