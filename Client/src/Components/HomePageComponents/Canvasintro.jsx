...
import Canvas1 from "../../assets/frontend_assets/CanvasCustomized/CanvasWallBanner.jpeg";
import CanvasPortrait from "../../assets/frontend_assets/CanvasCustomized/Portrait.jpeg";
import CanvasLandscape from "../../assets/frontend_assets/CanvasCustomized/Landscape.jpeg";
import Canvassquare from "../../assets/frontend_assets/CanvasCustomized/Square.jpeg";
...
const Canvasintro = () => {
  return (
    <div className="my-10 font-[poppins] w-full px-17">
      <div className="container mx-auto px-4 text-center">
        {/* Title */}
        <h1 className="text-4xl font-bold">Canvas Frame</h1>
